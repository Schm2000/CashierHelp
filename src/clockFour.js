...
function ClockFour() {
    ...
    return(
        ...
        <div style = {showExOne ? {display: 'none'}:{}}>$0.79</div>
        <div style = {showExOne ? {display: 'none'}:{}}>-$0.58</div>
        ...
        <div style = {showExOne ? {display: 'none'}:{}}>$7.00</div>
        ...
        <div style = {showExTwo ? {display: 'none'}:{}}>$1.00</div>
        <div style = {showExTwo ? {display: 'none'}:{}}>-$0.46</div>
        ...
        <div style = {showExTwo ? {display: 'none'}:{}}>-$3.00</div>
        <div style = {showExTwo ? {display: 'none'}:{}}>----</div>
        <div style={showExTwo ? {display:'none'}:{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
        <div>Type in answer here:  </div>
        <input style = {showExTwo ? {display: 'none'}:{marginLeft: '10px'}}></input>
        </div>
        <div style = {showExThree ? {display: 'none'}:{}}>$1.20</div>
        <div style = {showExThree ? {display: 'none'}:{}}>-$0.23</div>
        ...
        <div style = {showExThree ? {display: 'none'}:{}}>$5.00</div>
        <div style = {showExThree ? {display: 'none'}:{}}>-$4.00</div>
        <div style = {showExThree ? {display: 'none'}:{}}>----</div>
        <div style={showExThree ? {display:'none'}:{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
        <div>Type in answer here:  </div>
        <input style = {showExThree ? {display: 'none'}:{marginLeft: '10px'}}></input>
